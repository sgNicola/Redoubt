...
from src.simulation.runner.abstract_runner import AbstractRunner
...
class SimulationRunner(AbstractRunner):
    ...
    def run(self) -> RunnerReport:
        ...
        while self.simulation.is_simulation_running():
            ...
            _,  pi, encoder_feature=self.planner._run_planning_once(planner_input)
            
            results["hidden_feature"].append(encoder_feature[:,0:1])
            report.risk_score.append(pi)
