...
from src.custom_training.custom_distribution import TypeDistribution
...
class CustomDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if stage == "fit":
            ...
            logger.info("train_samples %d", len(train_samples))
            type_distribution = TypeDistribution()
            train_types = type_distribution.scenario_counts(train_samples)
            logger.info("train_sample_distribution %s", train_types)
            ...
            # logger.info("val_samples %d", len(val_samples))
            # val_types = type_distribution.scenario_counts(val_samples)
            # logger.info("train_sample_distribution %s", val_types)
