...
class ScopePlanner(AbstractPlanner):
    ...
    def compute_planner_trajectory(
        ...
        planning_trajectory,probability, encoder_feature = self._run_planning_once(current_input)
        del encoder_feature
    ...
    def _run_planning_once(self, current_input: PlannerInput):
        ...
        return trajectory, probability.flatten(), encoder_feature.detach().cpu()
