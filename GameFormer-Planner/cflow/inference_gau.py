...
def flow_sample(
    ...
    gaussian_log_density = Independent(
        Normal(torch.zeros(512, device=device), torch.ones(512, device=device)), 1
    ).log_prob
    k = 6
    latent_dim = 512
...
def run(data_dir, flow_checkpoint_path):
    ...
    test_set = SimulationDataset(root=data_dir , split="op_simulation_results")    
...
if __name__ == "__main__":
    ...
    flow_checkpoint_path = "./FM_model/gameformer_flow-epoch=1489-val_loss=0.0887.ckpt"
