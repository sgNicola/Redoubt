...
class RunnerReport:
    ...
    log_name: str
    scenario_type: str
    # ood_score: list # List of OOD scores for each simulations  
    scenario_distribution: Optional[str] # Distribution of scenarios In-distribution or Out-of-distribution
    risk_score: list # Risk score for the simulation