...
class NeuralPlanner(nn.Module):
    ...
    def forward(self, env_encoding, route_lanes, initial_state):
        ...
        return plan, env_route_encoding
...
class GameFormer(nn.Module):
    ...
    def forward(self, inputs):
        ...
        ego_plan, env_route_encoding = self.planner(env_encoding, route_lanes, initial_state)

        return  decoder_outputs, ego_plan, env_route_encoding.detach().cpu()