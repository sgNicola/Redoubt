...
def build_simulation(experiment, planner, scenarios, output_dir, simulation_dir, metric_dir):
    ...
    for scenario in tqdm(scenarios, desc='Running simulation'):
        ...
        # Todo: Add a callback to get the scenario type: scenario.scenario_type
...
def main(args):
    ...
    filter_params = get_filter_parameters(config_path="config/scenario_filter/test_all.yaml")
