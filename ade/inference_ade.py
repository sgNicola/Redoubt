...
def run(data_dir, ade_checkpoint_path):
    ...
    test_set = SimulationDataset(root= data_dir, split="cln_simulation_results")    
    ...
    save_path = f"{save_dir}/cln_driving_risk.parquet"
    driving_risk.to_parquet(save_path, index=False)
if __name__ == "__main__":
    data_dir = "/home/sgwang/PlanScope/plantf_dataset"
    ade_checkpoint_path =  '/home/sgwang/PlanScope/ade_model/plantf_ade-epoch=019-val_loss=0.1638.ckpt'
