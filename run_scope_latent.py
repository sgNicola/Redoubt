...
from src.models.pluto.inference_scope import PlanningModel
import os
...
def main(cfg: DictConfig):
    ...
    device = 'cpu'
    planscope_dataset = os.getenv("PLANSCOPE")   
    OT =80
    radius = model.radius
    ...
    with torch.no_grad():
        for batch_index, batch in enumerate(dataloader):
            ...
            save_path = f"{planscope_dataset}/{cfg.stage}_results/{batch_index}.pt"
            torch.save(
                results, save_path
            )
